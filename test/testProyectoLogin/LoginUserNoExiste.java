...
public class LoginUserNoExiste {
  ...
  @Test
  public void testLoginUserNoExiste() throws Exception {
    driver.get("http://localhost/login.php");
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("paco7@gmail.com");
    driver.findElement(By.name("password")).clear();
    driver.findElement(By.name("password")).sendKeys("ABab12!!");
    driver.findElement(By.name("login")).click();
    assertEquals("Revisa los datos!!!", driver.findElement(By.id("1")).getText());
  }
