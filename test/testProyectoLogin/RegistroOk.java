...
public class RegistroOk {
  ...
  public void testRegistroOk() throws Exception {
    ...
    assertEquals("¡Registrado exitosamente!", driver.findElement(By.cssSelector("div.alert.alert-success.alert-dismissable.fade.in > strong")).getText());
  }
