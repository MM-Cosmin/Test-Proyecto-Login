...
public class RegistroKoYaExiste {
	  ...
	  @Test
	  public void testRegistroKueYaExiste() throws Exception {
	    ...
	    assertEquals("Error de registro, Verifica tus datos.!", driver.findElement(By.cssSelector("div.alert.alert-danger.alert-dismissable.fade.in > strong")).getText());
	  }
